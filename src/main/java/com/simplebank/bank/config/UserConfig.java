...
public class UserConfig {
    ...
    @Bean
    public UseCase<UserDTORequest, UserDTOResponse> createUser(UserRepositoryGateway userRepository, CreateUserInputValidator validator, UserDTOMapper mapper) {
    ...
    @Bean
    public ControllerOperation<UserDTOResponse, UserDTORequest> createUserOperation(UseCase<UserDTORequest, UserDTOResponse> useCase) {
        return new CreateUserOperation(useCase);
    }

    @Bean
    public WebController<UserDTOResponse, UserDTORequest> createUserWebController(ControllerOperation<UserDTOResponse, UserDTORequest> operation) {
